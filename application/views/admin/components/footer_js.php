...
<script src="<?php echo base_url(); ?>admin_assets/bower_components/ckeditor/ckeditor.js"></script>
  ...
  <script>
    ...
    <!--<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>admin_assets/build/jquery.datetimepicker.css"/>
    <script src="<?php echo base_url();?>admin_assets/build/jquery.datetimepicker.full.js"></script>
      <script>
          jQuery( function() {
            jQuery(".datepicker").datetimepicker({minDate: -0,
                numberOfMonths: 1,
                onSelect: function (selected) {
                    var dt = new Date(selected);
                    dt.setDate(dt.getDate() + 1);
                    jQuery(".datepicker01").datetimepicker("option", "minDate", dt);
                }
            });
            jQuery(".datepicker01").datetimepicker({
                minDate: -0, numberOfMonths: 1,
                onSelect: function (selected) {
                    var dt = new Date(selected);
                    dt.setDate(dt.getDate() - 0);
                    jQuery(".datepicker").datetimepicker("option", "maxDate", dt);
                }
            });   
          });
    </script>-->  
