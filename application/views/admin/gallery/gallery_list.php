...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Gallery List <small>Control panel</small></h1>
      <ol class="breadcrumb">
...
<table id="example1" class="table table-striped table-bordered bootstrap-datatable responsive datatable">
    ...
    <tr>
        ...
        <td style="width: 20%;"><?php echo $ae->location; ?></td>
		<?php if($ae->images) { ?>
		  <td class="center"><img src="<?php echo base_url('uploads/gallery')."/".$ae->images; ?>" height="50"></td>
		<?php } ?>
        <td class="center" style="width: 20%;">
        	<?php echo date("d F Y",strtotime($ae->date)); ?>
        </td>
        <td class="center" style="width: 5%;">
        <?php
        if($ae->status==1){
        ?>
        <p><a href="<?php echo base_url('admin/gallery_status/'.$ae->id.'/0/'); ?>"><span class="label label-success">Active</span></a></p>
        <?php } else { ?>
        <p><a href="<?php echo base_url('admin/gallery_status/'.$ae->id.'/1/'); ?>"><span class="label label-danger">Inactive</span></a></p>
        <?php } ?>
        </td>
        <td style="width: 5%;">
           <p><a  data-toggle="modal" data-target=".remove-product-modal" class="remove-product" ad-details="<?php echo base_url('admin/gallery_delete/'.$ae->id.'/'); ?>" href="#"><span class="btn btn-danger"><i class="glyphicon glyphicon-trash icon-white"></i></span></a></p>
           <p><a href="<?php echo base_url('admin/edit_gallery/'.$ae->id.'/'); ?>" ><span class="btn btn-info"><i class="glyphicon glyphicon-edit icon-white"></i></span></a></p>
           <p><a href="<?php echo base_url('admin/add_album/'.$ae->id.'/'); ?>" ><span class="btn btn-info">Add Album</span></a></p>
        </td>
    </tr>
    <?php } } ?>
    </tbody>
