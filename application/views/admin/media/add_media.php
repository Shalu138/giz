  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="margin-bottom: 30px;">
       <div class="box">
            ...
            <!-- /.box-header -->
              <div class="box-body">
                    <form name="elementForm" id="leadAddForm" role="form" action="<?php echo base_url(); ?>Admin/add_mediadata" method="post" enctype="multipart/form-data">
		              <div class="col-md-6">
					  ...
					  <div class="col-md-6">
			              <div class="form-group">
			                  ...
			                  <input type="text" class="form-control" placeholder="Enter Organizer Name" name="organizer" value="">
						 </div>
					  </div>
					  <div class="col-md-12">
						<div class="form-group">
