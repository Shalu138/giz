...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Media List <small>Control panel</small></h1>
      <ol class="breadcrumb">
    ...
    <section class="content" style="margin-bottom: 30px;">
       <div class="box">
             ...
             <div class="col-lg-4 btn-class">
               <a href="<?php echo base_url(); ?>Admin/add_media" class="btn btn-flat margin" style="background-color: #605ca8; color: #fff;"><span class="fa fa-plus-circle" ></span> Add Media</a>&nbsp;
              <a href="<?php echo base_url(); ?>Admin/media_list" class="btn btn-flat margin" style="background-color: #605ca8; color: #fff;"><span class="fa fa-list"></span> Media List</a>&nbsp;
            </div> 
            <div class="col-lg-4">
...
<table id="example1" class="table table-striped table-bordered bootstrap-datatable responsive datatable">
    ...
    <tr>
        ...
        <td style="width: 25%;"><?php echo $ae->title; ?></td>
        <td style="width: 20%;"><?php echo $ae->organizer; ?></td>
		<?php if($ae->images) { ?>
		  <td class="center"><img src="<?php echo base_url('uploads/media')."/".$ae->images; ?>" height="50"></td>
		<?php } ?>
        <td class="center" style="width: 20%;">
        	<?php echo date("d F Y",strtotime($ae->created_at)); ?>
        </td>
        <td class="center" style="width: 5%;">
        <?php
        if($ae->status==1){
        ?>
        <p><a href="<?php echo base_url('admin/media_status/'.$ae->id.'/0/'); ?>"><span class="label label-success">Active</span></a></p>
        <?php } else { ?>
        <p><a href="<?php echo base_url('admin/media_status/'.$ae->id.'/1/'); ?>"><span class="label label-danger">Inactive</span></a></p>
        <?php } ?>
        </td>
        <td style="width: 5%;">     
           <p><a  data-toggle="modal" data-target=".remove-product-modal" class="remove-product" ad-details="<?php echo base_url('admin/media_delete/'.$ae->id.'/'); ?>" href="#"><span class="btn btn-danger"><i class="glyphicon glyphicon-trash icon-white"></i></span></a></p>
           <p><a href="<?php echo base_url('admin/edit_media/'.$ae->id.'/'); ?>" ><span class="btn btn-info"><i class="glyphicon glyphicon-edit icon-white"></i></span></a></p>
        </td>
    </tr>
    <?php } } ?>
    </tbody>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content pop-up-bg-color" style="background-color: #00a7d0;border-color: #00a7d0;color: white;border-radius: 0;">
        <div class="modal-header" style="padding: 0px 13px;border-bottom: 1px solid #e5e5e5;">
        	<h3 style="color:white; font-size: 26px;">Media</h3>
        ...
        <div class="row">
          <p class="text-center" style="font-size: 15px;font-weight: 500;color:white;">Do you really want to remove this Media.</p>
        </div>
       </div> 
